# progol_optimizer/main.py - VERSIÓN MEJORADA OPCIONAL
"""
Orquestador Principal - Ejecuta el pipeline completo de optimización
MEJORAS v2.0: Verificación de dependencias + Parser PDF opcional
"""
...
# NUEVO: Verificar dependencias opcionales
try:
...
class ProgolOptimizer:
    ...
    VERSIÓN 2.0 con optimizaciones de velocidad y fidelidad
    """
    
    def __init__(self):
        self.logger = logging.getLogger(__name__)
        
        # NUEVO: Log de dependencias disponibles
        ...
        self.calibrator = BayesianCalibrator()  # Ahora con Bivariate-Poisson integrado
    ...
    def _verificar_dependencias(self):
        """
        NUEVO: Verifica dependencias opcionales y reporta estado
        """
    ...
    def procesar_concurso(self, archivo_datos: str = None, concurso_id: str = "2283", 
        ...
        NUEVO: Soporte opcional para previas PDF
        
        Args:
            archivo_datos: Ruta al archivo CSV (opcional)
            concurso_id: ID del concurso
            archivo_previas_pdf: NUEVO - Ruta al PDF de previas (opcional)
        ...
        try:
            ...
            # PASO 1.5: NUEVO - Enriquecer con PDF de previas si está disponible
            ...
            # PASO 2-8: Sin cambios (misma interfaz, mejoras internas)
            ...
            for i, partido in enumerate(partidos):
                # Calibración bayesiana MEJORADA (ahora con Bivariate-Poisson + stacking)
    ...
    def _enriquecer_con_previas(self, partidos: List[Dict[str, Any]], 
        ...
        """
        NUEVO: Enriquece partidos básicos con datos extraídos de previas PDF
        """
...
def main():
    ...
    parser.add_argument("--previas", "-p", help="NUEVO: Archivo PDF con previas")
    ...
    resultado = optimizer.procesar_concurso(
        ...
        archivo_previas_pdf=args.previas  # NUEVO
    )
